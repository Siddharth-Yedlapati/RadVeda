package RadVeda.ConsentManagement.transitEncryption;
...
public class EncryptionService {
    ...
    public void generateKeyPair() {
        ...
        try {
            ...
            CMS = gen.generateKeyPair();

            byte[] keyBytes = CMS.getPublic().getEncoded();
...
//            String base64encodedKey = Base64.
            ...
            ResponseEntity<String> res  = restTemplate.exchange("http://localhost:9191/encryptor/sendPublicKey/CMS",
    ...
    public String storeSharedKey(String service, byte[] keyBytes) {
        try {
            String sharedKey = decrypt(keyBytes, CMS.getPrivate());
