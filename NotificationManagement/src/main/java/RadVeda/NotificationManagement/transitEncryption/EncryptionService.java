...
public class EncryptionService {
    ...
    public void generateKeyPair() {
        ...
        try {
            ...
            NMS = gen.generateKeyPair();

            byte[] keyBytes = NMS.getPublic().getEncoded();
...
//            String base64encodedKey = Base64.
            ...
            ResponseEntity<String> res  = restTemplate.exchange("http://localhost:9191/encryptor/sendPublicKey/NMS",
    ...
    public String storeSharedKey(String service, byte[] keyBytes) {
        try {
            String sharedKey = decrypt(keyBytes, NMS.getPrivate());
