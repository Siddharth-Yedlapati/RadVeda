    ...
    <>
      <div className="doc-own-pfr-rad">
        ...
        <div className="iconnotification-bing26">
          <img className="vector-icon118" alt="" src="/vector.svg" onClick={openNotifications}/>
          <img className="vector-icon119" alt="" src="/vector.svg" onClick={openNotifications}/>
          <img className="vector-icon120" alt="" onClick={openNotifications}/>
          <div className="iconnotification-bing-child24" onClick={openNotifications}/>
