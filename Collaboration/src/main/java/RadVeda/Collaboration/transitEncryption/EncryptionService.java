package RadVeda.Collaboration.transitEncryption;
...
public class EncryptionService {
    ...
    private KeyPair collaboaration;
    ...
    public void generateKeyPair() {
        ...
        try {
            ...
            collaboaration = gen.generateKeyPair();

            byte[] keyBytes = collaboaration.getPublic().getEncoded();
...
//            String base64encodedKey = Base64.
            ...
            ResponseEntity<String> res  = restTemplate.exchange("http://localhost:9191/encryptor/sendPublicKey/collaboaration",
    ...
    public String storeSharedKey(String service, byte[] keyBytes) {
        try {
            String sharedKey = decrypt(keyBytes, collaboaration.getPrivate());
