...
const RadiologistSignupThreePage = () => {
      ...
      >
        <div className="flex flex-col font-juliussansone h-full items-center justify-start max-w-[1116px] mt-auto mx-auto md:px-5 w-full">
          <div className="flex flex-col gap-11 justify-start w-full">
            <Text
              className="md:ml-[0] ml-[46px] text-4xl sm:text-[32px] md:text-[34px] text-black-900 text-center w-[35%] sm:w-full"
        ...
        <Input
          ...
          className="font-inter font-medium p-0 placeholder:text-gray-800 text-left text-sm tracking-[0.15px] w-full"
          wrapClassName="absolute bottom-[28%] left-[11%] w-[32%]"
          type="number"
          shape="round"
          color="gray_300"
          size="md"
...
export default RadiologistSignupThreePage;
