...
const DoctorConsultationPendingForReviewByDoctorHistoryPage = () => {
  return (
    <>
      <div className="bg-gray-900 font-outfit h-[859px] mx-auto p-[7px] relative w-full">
        <div className="absolute bg-blue_gray-900 flex flex-col h-max inset-[0] items-start justify-center m-auto max-w-[1411px] p-[22px] md:px-5 rounded-[10px] w-full">
          <div className="flex flex-col md:gap-10 gap-[442px] justify-start md:ml-[0] ml-[21px] mt-28 w-[90%] md:w-full">
            <div className="flex flex-col gap-[25px] items-center justify-start md:ml-[0] ml-[866px] w-[30%] md:w-full">
              <Button
        ...
        <div className="absolute flex flex-col font-poppins items-start justify-start left-[2%] pt-2 px-2 md:px-5 top-[3%] w-[61%]">
          <div className="flex flex-col justify-start mt-[37px] w-[93%] md:w-full">
            ...
            <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start mr-[19px] mt-[50px] w-[98%] md:w-full">
            ...
            <div className="flex flex-col font-outfit gap-[29px] items-center justify-start md:ml-[0] ml-[434px] mt-[38px] w-[46%] md:w-full">
              <Button
                className="capitalize cursor-pointer font-semibold h-[65px] rounded-lg text-center text-lg tracking-[0.36px] w-[361px]"
                shape="round"
                size="3xl"
              ...
              <Button
                className="capitalize cursor-pointer font-semibold h-[54px] rounded-lg text-center text-lg tracking-[0.36px] w-[361px]"
                shape="round"
                size="lg"
                color="green_500_teal_400"
              >
...
export default DoctorConsultationPendingForReviewByDoctorHistoryPage;
