...
const RadiologistConsultationDiagnosisCompletedPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-gray-900 font-outfit h-[859px] mx-auto p-[7px] relative w-full">
        <div className="absolute bg-blue_gray-900 flex flex-col h-max inset-[0] items-start justify-center m-auto max-w-[1411px] p-6 md:px-5 rounded-[10px] w-full">
          <div className="flex flex-col gap-[30px] justify-start mb-5 mt-12 w-[95%] md:w-full">
            <div className="flex flex-col justify-start md:ml-[0] ml-[915px] w-[29%] md:w-full">
              <div className="bg-gradient  flex flex-col h-[42px] md:h-auto items-center justify-center md:ml-[0] ml-[29px] rounded-lg w-[279px]">
              ...
              <div className="flex flex-row font-poppins items-center justify-start mt-[11px] w-[96%] md:w-full">
                ...
                <div className="bg-blue_gray-800 flex flex-col md:gap-10 gap-[72px] items-end justify-start p-[22px] sm:px-5 rounded-[10px] w-[92%]">
                  <Text
                  ...
                  <Img
                    className="h-[183px] md:h-auto mb-[34px] object-cover w-[98%] sm:w-full"
                    src="images/img_annotelyimage1.png"
                    alt="annotelyimageOne"
                  />
                </div>
              </div>
              <div className="flex flex-col font-outfit gap-6 items-center justify-start ml-3 md:ml-[0] mt-[37px] w-[97%] md:w-full">
                <Button
            ...
            <Button
              ...
              onClick={() => navigate("/radiologistconsultationpatientdetails")}
              shape="round"
              size="sm"
              color="green_500_teal_400"
            >
        ...
        <div className="absolute flex flex-col font-poppins items-start justify-end left-[2%] md:px-5 top-[3%] w-[61%]">
          <div className="flex flex-col justify-start md:ml-[0] ml-[7px] mt-11 w-[91%] md:w-full">
            <Text
            ...
            <div className="flex flex-col font-outfit gap-6 items-start justify-start md:ml-[0] ml-[17px] mt-[31px] w-[98%] md:w-full">
...
export default RadiologistConsultationDiagnosisCompletedPage;
