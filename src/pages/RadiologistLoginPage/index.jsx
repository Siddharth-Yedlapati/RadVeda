...
const RadiologistLoginPagePage = () => {
    ...
    <>
      ...
      >
        <div className="flex flex-col items-center justify-start md:ml-[0] ml-[88px] mt-[29px] w-[36%] md:w-full">
          <Text
            className="text-4xl sm:text-[32px] md:text-[34px] text-black-900 text-center w-[82%] sm:w-full"
          ...
          <div className="flex flex-col items-start justify-start mt-[42px] w-[99%] md:w-full">
            ...
            <div className="flex flex-row gap-5 items-start justify-center md:ml-[0] ml-[101px] mt-[27px] w-3/5 md:w-full">
              <a
                href="javascript:"
                className="mt-[3px] text-base text-center text-gray-600"
              >
...
export default RadiologistLoginPagePage;
