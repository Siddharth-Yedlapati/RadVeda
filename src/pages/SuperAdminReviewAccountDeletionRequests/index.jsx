...
const SuperAdminReviewAccountDeletionRequestsPage = () => {
                    ...
                    <div className="absolute sm:h-[213px] h-[216px] md:h-[558px] inset-[0] justify-center m-auto w-full">
                      <div className="flex flex-col h-full items-center justify-start m-auto w-full">
                        <div className="flex flex-col items-start justify-start w-full">
                          ...
                          <div className="flex flex-row gap-5 items-start justify-start mt-[9px] pr-[13px] w-[23%] md:w-full">
                            <Button
                          ...
                          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mt-[3px] w-full">
                      ...
                      <div className="absolute flex flex-row font-outfit gap-[39px] items-start justify-center left-[26%] top-[0] w-[35%]">
                        ...
                        <div className="font-poppins md:h-[198px] h-[200px] relative w-[59%]">
                          ...
                          <div className="absolute bottom-[0] flex flex-col font-outfit gap-[27px] items-center justify-start left-[17%] w-[47%]">
                            <Button
...
export default SuperAdminReviewAccountDeletionRequestsPage;
