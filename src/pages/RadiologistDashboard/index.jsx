...
const RadiologistDashboardPage = () => {
    ...
    <>
      <div className="bg-gray-900 flex flex-col font-poppins items-center justify-start mx-auto pl-[7px] py-[7px] w-full">
        <div className="flex flex-col gap-2.5 justify-start max-w-[1438px] mb-[19px] mx-auto md:px-5 w-full">
          ...
          <div className="md:h-[688px] sm:h-[784px] h-[786px] relative w-full">
            <div className="md:h-[688px] sm:h-[784px] h-[786px] m-auto w-full">
              <div className="absolute bg-blue_gray-900 flex flex-col h-full inset-[0] items-start justify-center m-auto p-[27px] sm:px-5 rounded-[10px] w-[99%]">
                <div className="flex flex-col items-center justify-start mb-[399px] mt-[77px] w-3/5 md:w-full">
                  <div className="flex flex-col md:gap-10 gap-[136px] items-start justify-start pb-[31px] sm:px-5 px-[31px] w-full">
                    <Text
                      className="bg-clip-text bg-gradient1  md:ml-[0] ml-[67px] sm:text-[29.36px] md:text-[31.36px] text-[33.36px] text-transparent"
                    ...
                    <div className="bg-gray-50_ed flex flex-row font-sfprotext h-9 md:h-auto items-center justify-start md:ml-[0] ml-[71px] p-2 rounded-[10px] w-[300px]">
              ...
              <div className="absolute bottom-[10%] flex flex-col gap-3 items-start justify-center pl-[17px] py-[17px] right-[0] w-[44%]">
                <Text
                ...
                <div className="h-[206px] mb-[7px] relative w-full">
                  <div className="absolute bottom-[0] flex flex-col items-center justify-start left-[0] w-[82%]">
                    <List
                      className="flex flex-col gap-[19px] items-center w-full"
                      orientation="vertical"
                    >
                      <div className="flex flex-1 flex-row gap-5 items-center justify-start my-0 md:pr-10 sm:pr-5 pr-[374px] w-full">
                        <Button
                      ...
                      <div
                        className="common-pointer flex flex-1 flex-row gap-5 items-center justify-start my-0 md:pr-10 sm:pr-5 pr-[371px] w-full"
                        onClick={() =>
                      ...
                      <div className="flex flex-1 flex-row gap-5 items-center justify-start my-0 md:pr-10 sm:pr-5 pr-[370px] w-full">
                        <Button
                          className="flex h-10 items-center justify-center w-10"
                          shape="round"
                  ...
                  <div className="absolute flex flex-row sm:gap-10 h-max inset-[0] items-start justify-between m-auto md:pr-10 sm:pr-5 pr-[139px] w-full">
                    <Text
            ...
            <div className="absolute bottom-[10%] flex flex-col gap-3 items-start justify-center left-[9%] pl-[17px] py-[17px] w-[54%]">
              <Text
                className="capitalize mt-1 text-lg text-white-A700"
                size="txtPoppinsBold18"
              >
              ...
              <div className="h-[206px] mb-[7px] relative w-full">
                <div className="absolute bottom-[0] flex flex-col items-center justify-start left-[0] w-[72%]">
                  <List
                    ...
                    orientation="vertical"
                  >
                    <div className="flex flex-1 flex-row gap-5 items-center justify-start my-0 md:pr-10 sm:pr-5 pr-[408px] w-full">
                      <Button
                        className="flex h-10 items-center justify-center w-10"
                        shape="round"
                        color="yellow_400"
                    ...
                    <div
                      className="common-pointer flex flex-1 flex-row gap-5 items-center justify-start my-0 md:pr-10 sm:pr-5 pr-[405px] w-full"
                    ...
                    <div className="flex flex-1 flex-row gap-5 items-center justify-start my-0 md:pr-10 sm:pr-5 pr-[404px] w-full">
                      <Button
                        className="flex h-10 items-center justify-center w-10"
                        shape="round"
                        color="deep_purple_A200"
