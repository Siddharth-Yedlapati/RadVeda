...
const RadiologistSignupTwoPage = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col items-center max-w-[1115px] mt-[73px] mx-auto md:px-5 w-full">
          <div className="md:h-[440px] sm:h-[660px] h-[695px] relative w-full">
            <div className="absolute flex flex-col font-juliussansone md:gap-10 gap-[260px] inset-x-[0] justify-start mx-auto top-[0] w-full">
              <div className="flex flex-col gap-[42px] items-center justify-start mr-[655px] w-[42%] md:w-full">
                <Text
                ...
                <div className="flex flex-col font-inter gap-[37px] items-center justify-start w-full">
                  <SelectBox
                    className="font-medium text-left text-sm tracking-[0.15px] w-full"
            ...
            <Button
              ...
              onClick={() => navigate("/radiologistsignupthree")}
              shape="round"
              color="indigo_A400"
              size="lg"
              variant="fill"
            ...
            <Button
              ...
              onClick={() => navigate("/radiologistsignupone")}
              shape="round"
              color="indigo_A400"
              size="lg"
              variant="fill"
...
export default RadiologistSignupTwoPage;
