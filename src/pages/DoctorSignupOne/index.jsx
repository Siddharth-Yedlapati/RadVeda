      ...
      >
        <div className="flex flex-col font-juliussansone h-full items-center justify-start max-w-[1115px] mt-auto mx-auto md:px-5 w-full">
          <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
            <div className="flex flex-col md:gap-10 gap-[118px] items-center justify-start">
              <Text
              ...
              <div className="flex flex-col font-inter items-start justify-start w-full">
                <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between w-full">
                  ...
                  />
                  <LabStaffSignupOneColumnlabel
                    className="h-14 md:h-[51px] relative w-[139px]"
                    dateofbirth="Middle name"
                  />
                  <LabStaffSignupOneColumnlabel
                    className="bg-gray-50 flex flex-col gap-[3px] h-14 md:h-auto items-start justify-start rounded-[10px] shadow-bs w-[139px]"
                ...
                <div className="flex sm:flex-col flex-row gap-4 items-center justify-start mt-[37px] w-[85%] md:w-full">
                  <SelectBox
                    className="font-medium h-14 text-left text-sm tracking-[0.15px] w-[31%] sm:w-full"
            ...
            <Line className="bg-teal-300 h-px mb-[76px] md:mt-0 mt-[662px] w-[31%]" />
          </div>
        </div>
        <div className="absolute bottom-[8%] flex md:flex-col flex-row font-kanit md:gap-5 inset-x-[0] items-start justify-start mx-auto md:px-5 w-1/2">
          <Button
            ...
            onClick={() => navigate("/doctorsignuptwo")}
            shape="round"
            color="indigo_A400"
            size="lg"
            variant="fill"
...
export default DoctorSignupOnePage;
