    ...
    <>
      ...
      >
        <div className="flex flex-col font-juliussansone h-full items-center justify-start max-w-[1116px] mt-auto mx-auto md:px-5 w-full">
          <div className="flex flex-col md:gap-10 gap-[120px] justify-start w-full">
            <Text
              className="md:ml-[0] ml-[52px] text-4xl sm:text-[32px] md:text-[34px] text-black-900 text-center"
...
export default DoctorSignupThreePage;
