...
const DoctorConsultationPendingForReviewPage = () => {
    ...
    <>
      <div className="bg-gray-900 font-outfit h-[859px] mx-auto p-[7px] relative w-full">
        <div className="absolute bg-blue_gray-900 flex flex-col h-max inset-[0] items-start justify-center m-auto max-w-[1411px] p-[22px] md:px-5 rounded-[10px] w-full">
          <div className="flex flex-col md:gap-10 gap-[198px] justify-start md:ml-[0] ml-[21px] mt-28 w-[90%] md:w-full">
            <div className="flex flex-col gap-[17px] items-center justify-start md:ml-[0] ml-[866px] w-[30%] md:w-full">
              <Button
              ...
              <Button
                ...
                onClick={() =>
                  navigate("/doctorconsultationconsultotherdoctors")
                }
                shape="round"
                size="3xl"
                color="green_500_teal_400"
...
export default DoctorConsultationPendingForReviewPage;
