...
const PatientPendingForReviewByDoctorPage = () => {
  ...
  return (
    <>
      <div className="bg-gray-900 font-outfit h-[859px] mx-auto p-[7px] relative w-full">
        ...
        <Button
          className="absolute bottom-[24%] capitalize cursor-pointer font-semibold h-[65px] inset-x-[0] mx-auto rounded-lg text-center text-lg tracking-[0.36px] w-[361px]"
          shape="round"
          size="3xl"
          color="green_500_teal_400"
        >
...
export default PatientPendingForReviewByDoctorPage;
