...
const PatientSignupThreePage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div
        className="bg-cover bg-no-repeat flex font-juliussansone h-[859px] justify-end mx-auto p-6 sm:px-5 relative w-full"
        style={{ backgroundImage: "url('images/img_labstaffsignupone.png')" }}
      >
        <div className="flex flex-col h-full items-center justify-start max-w-[1116px] mt-auto mx-auto md:px-5 w-full">
          <div className="flex flex-col gap-11 justify-start w-full">
            ...
            <div className="flex flex-col font-inter items-start justify-start w-full">
              ...
              ></Input>
              <Text
                className="ml-3.5 md:ml-[0] mt-1.5 text-[13px] text-gray-600 w-[42%] sm:w-full"
              ...
              ></Input>
              <Button
                className="cursor-pointer font-medium h-[25px] md:ml-[0] ml-[213px] mt-2.5 text-center text-sm tracking-[0.15px] w-[247px]"
                shape="round"
                color="gray_50"
                size="xs"
                variant="fill"
              ...
              <div className="flex sm:flex-col flex-row font-kanit sm:gap-5 items-start justify-start mt-[75px] w-full">
                <Button
...
export default PatientSignupThreePage;
