...
const DoctorConsultationPendingForReviewByRadiologistHistoPage = () => {
  return (
    <>
      <div className="bg-gray-900 font-outfit h-[859px] mx-auto p-[7px] relative w-full">
        <div className="absolute bg-blue_gray-900 flex flex-col h-max inset-[0] items-start justify-center m-auto max-w-[1411px] p-9 md:px-5 rounded-[10px] w-full">
          <div className="flex flex-col md:gap-10 gap-[85px] justify-start mb-6 mt-[507px] w-[96%] md:w-full">
            <Button
              className="capitalize cursor-pointer font-semibold h-[65px] md:ml-[0] ml-[917px] rounded-lg text-center text-lg tracking-[0.36px] w-[361px]"
              shape="round"
              size="3xl"
        ...
        <div className="absolute flex flex-col font-poppins items-end justify-start left-[2%] pl-[37px] md:px-5 py-[37px] top-[3%] w-[61%]">
          <div className="flex md:flex-col flex-row gap-[42px] items-start justify-end mb-[35px] mt-2 w-full">
            <div className="flex md:flex-1 flex-col md:gap-10 gap-[462px] justify-start w-[54%] md:w-full">
              <Text
              ...
              <Button
                className="capitalize cursor-pointer font-outfit font-semibold h-[65px] md:ml-[0] ml-[89px] rounded-lg text-center text-lg tracking-[0.36px] w-[361px]"
                shape="round"
                size="3xl"
                color="green_500_teal_400"
              >
            ...
            <div className="h-[78px] md:mt-0 mt-[230px] relative w-[4%] md:w-full">
            ...
            <div className="h-[363px] md:mt-0 mt-[79px] relative w-[39%] md:w-full">
...
export default DoctorConsultationPendingForReviewByRadiologistHistoPage;
