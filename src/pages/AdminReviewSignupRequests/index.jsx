...
const AdminReviewSignupRequestsPage = () => {
    ...
    <>
      <div className="bg-gray-900 flex flex-col font-poppins items-center justify-start mx-auto p-[7px] w-full">
        <div className="flex flex-col justify-start max-w-[1411px] mb-[19px] mx-auto md:px-5 w-full">
          ...
          <div className="md:h-[1218px] sm:h-[788px] h-[793px] mt-[3px] relative w-full">
            <div className="font-poppins md:h-[1215px] sm:h-[785px] h-[793px] m-auto w-full">
              <div className="absolute bg-blue_gray-900 flex flex-col h-max inset-[0] items-end justify-center m-auto p-1 rounded-[10px] w-full">
                <div className="flex flex-col items-center justify-start mb-[362px] mt-[216px] w-[32%] md:w-full">
                  <div className="flex flex-row items-end justify-between w-full">
                    <div className="flex flex-col gap-4 items-end justify-start w-2/5">
                      <Text
                    ...
                    <List
                      className="flex flex-col font-outfit gap-[27px] mb-1 mt-[49px] w-[37%]"
                      orientation="vertical"
                    >
                      <div className="flex flex-row gap-[18px] items-center justify-between w-[98%] md:w-full">
                      ...
                      <div className="flex flex-row gap-[22px] items-start justify-between w-full">
                        <div className="bg-gradient  flex flex-col h-[33px] md:h-auto items-center justify-center mb-[3px] rounded-lg w-[70px]">
                          <div className="flex flex-col items-center justify-start">
                            <Text
                              className="capitalize text-lg text-white-A700 tracking-[0.36px]"
                              size="txtOutfitSemiBold18"
                        ...
                        <div className="bg-pink-800 flex flex-col h-[33px] md:h-auto items-center justify-center mt-[3px] rounded-lg w-[71px]">
                          <div className="flex flex-col items-center justify-start">
                            <Text
                              className="capitalize text-lg text-white-A700 tracking-[0.36px]"
                              size="txtOutfitSemiBold18"
              ...
              <div className="absolute flex flex-col font-sfprotext gap-14 justify-center left-[0] md:pl-10 sm:pl-5 pl-[58px] py-[58px] top-[0] w-[63%]">
                ...
                <div className="flex font-poppins mb-[191px] relative w-full">
                  <div className="flex flex-col gap-2.5 justify-start my-auto pl-0.5 py-0.5 w-[94%]">
                    <Text
                    ...
                    <div className="sm:h-[217px] h-[221px] md:h-[657px] mb-4 relative w-full">
                      <div className="font-poppins sm:h-[201px] h-[221px] md:h-[641px] m-auto w-full">
                        <div className="absolute sm:h-[201px] h-[216px] md:h-[641px] inset-[0] justify-center m-auto w-full">
                          <div className="absolute bottom-[0] flex flex-col items-center justify-start left-[0] w-[48%]">
                            <div className="flex flex-col gap-[11px] items-start justify-start w-full">
                              <div className="flex flex-row gap-5 items-start justify-start md:pr-10 sm:pr-5 pr-[68px] w-[59%] md:w-full">
                              ...
                              <div className="flex flex-row gap-5 items-start justify-start md:pr-10 sm:pr-5 pr-[58px] w-[59%] md:w-full">
                          ...
                          <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto md:px-10 sm:px-5 px-[51px] top-[0] w-full">
                            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[99%] md:w-full">
                              ...
                              <div className="flex flex-col items-start justify-start md:ml-[0] ml-[135px] px-[5px]">
                                <Text
                              ...
                              <div className="flex flex-col font-outfit gap-[27px] items-center justify-start md:ml-[0] ml-[71px] md:mt-0 mt-[45px] w-[11%] md:w-full">
                                <Button
                              ...
                              <div className="flex flex-col font-poppins items-start justify-start md:ml-[0] ml-[99px]">
                                <Text
                        ...
                        <Text
                          className="absolute capitalize right-[39%] sm:text-[17px] md:text-[19px] text-[21px] text-indigo-600 top-[0]"
                          size="txtPoppinsSemiBold21"
                        >
                          Info
                        </Text>
                        <div className="absolute flex flex-col gap-3 items-center justify-start pb-[58px] right-[12%] top-[1%] w-[17%]">
                          <Text
                            className="capitalize sm:text-[17px] md:text-[19px] text-[21px] text-indigo-600"
                            size="txtPoppinsSemiBold21"
                          >
                          ...
                          <div className="flex flex-col font-outfit gap-[30px] items-center justify-start w-[57%] md:w-full">
                            <Button
                              className="capitalize cursor-pointer font-semibold h-[33px] rounded-lg text-center text-lg tracking-[0.36px] w-[70px]"
                              shape="round"
                              size="sm"
                      ...
                      <Button
                        className="absolute bottom-[8%] capitalize cursor-pointer font-outfit font-semibold h-[33px] right-[16%] rounded-lg text-center text-lg tracking-[0.36px] w-[70px]"
                        shape="round"
                        size="sm"
                        color="green_500_teal_400"
                      >
                  ...
                  <div className="flex flex-col items-end justify-start mb-[30px] ml-[-14px] mt-auto md:pl-10 sm:pl-5 pl-[108px] z-[1]">
                    <Text
                      className="capitalize sm:text-[17px] md:text-[19px] text-[21px] text-indigo-600"
                      size="txtPoppinsSemiBold21"
                    >
                    ...
                    <Text
                      className="capitalize mt-[17px] sm:text-[19px] md:text-[21px] text-[23px] text-gray-100"
                      size="txtPoppinsMedium23"
                    >
                      Male
                    </Text>
...
export default AdminReviewSignupRequestsPage;
