...
const DoctorConsultationDiagnosisCompletedHistoryPage = () => {
  return (
    <>
      <div className="bg-gray-900 font-outfit h-[859px] mx-auto p-[7px] relative w-full">
        <div className="absolute bg-blue_gray-900 flex flex-col h-max inset-[0] items-start justify-center m-auto max-w-[1411px] p-9 md:px-5 rounded-[10px] w-full">
          <div className="flex flex-col md:gap-10 gap-[313px] justify-start mb-6 mt-[101px] w-[93%] md:w-full">
            <div className="flex flex-col gap-6 items-center justify-start md:ml-[0] ml-[873px] w-[30%] md:w-full">
              <Button
...
export default DoctorConsultationDiagnosisCompletedHistoryPage;
