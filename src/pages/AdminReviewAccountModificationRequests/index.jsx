...
const AdminReviewAccountModificationRequestsPage = () => {
    ...
    <>
      <div className="bg-gray-900 flex flex-col font-poppins items-center justify-start mx-auto p-[7px] w-full">
        <div className="flex flex-col justify-start max-w-[1411px] mb-[19px] mx-auto md:px-5 w-full">
          ...
          <div className="md:h-[788px] h-[793px] sm:h-[960px] mt-[3px] relative w-full">
            <div className="font-poppins md:h-[785px] h-[793px] sm:h-[957px] m-auto w-full">
              ...
              <div className="absolute flex flex-col font-sfprotext gap-14 justify-center left-[0] md:pl-10 sm:pl-5 pl-[58px] py-[58px] top-[0] w-[63%]">
                ...
                <div className="flex font-poppins mb-[191px] relative w-full">
                  <div className="flex flex-col gap-[15px] justify-start my-auto pl-0.5 py-0.5 w-[94%]">
                    <Text
                    ...
                    <div className="h-[216px] md:h-[217px] sm:h-[485px] mb-4 relative w-full">
                      <div className="md:h-[201px] h-[216px] sm:h-[469px] m-auto w-full">
                        <div className="md:h-[201px] h-[216px] sm:h-[469px] m-auto w-full">
                          <div className="absolute bottom-[0] flex flex-col items-center justify-start left-[0] w-[48%]">
                            <div className="flex flex-col gap-[11px] items-start justify-start w-full">
                              <div className="flex flex-row gap-5 items-start justify-start md:pr-10 sm:pr-5 pr-[71px] w-3/5 md:w-full">
                              ...
                              <div className="flex flex-row gap-5 items-start justify-start md:pr-10 sm:pr-5 pr-[61px] w-3/5 md:w-full">
                          ...
                          <div className="absolute flex flex-col inset-x-[0] items-start justify-start mx-auto md:px-10 sm:px-5 px-[51px] top-[0] w-full">
                            <div className="flex sm:flex-col flex-row sm:gap-5 items-start justify-start w-[64%] md:w-full">
                              <Text
                                className="capitalize sm:text-[17px] md:text-[19px] text-[21px] text-indigo-600"
                                size="txtPoppinsSemiBold21"
                              >
                              ...
                              <div className="flex flex-col items-start justify-start sm:ml-[0] ml-[135px] px-[5px]">
                                <Text
                              ...
                              <div className="flex flex-col gap-[18px] items-center justify-start sm:ml-[0] ml-[61px] sm:mt-0 mt-[3px] w-[17%] sm:w-full">
                                <Text
                                  className="capitalize sm:text-[17px] md:text-[19px] text-[21px] text-indigo-600"
                                  size="txtPoppinsSemiBold21"
                                >
                        ...
                        <div className="absolute flex flex-col h-max inset-y-[0] items-start justify-start my-auto right-[8%]">
                          ...
                          <Text
                            className="capitalize md:ml-[0] ml-[117px] mt-[22px] sm:text-[19px] md:text-[21px] text-[23px] text-gray-100"
                            size="txtPoppinsMedium23"
                          >
                            22 yrs
                          </Text>
                          <Text
                            className="capitalize md:ml-[0] ml-[121px] mt-[21px] sm:text-[19px] md:text-[21px] text-[23px] text-gray-100"
                            size="txtPoppinsMedium23"
                          >
                            3 yrs
                          </Text>
                      ...
                      <div className="absolute flex flex-col gap-[15px] h-max inset-y-[0] items-center justify-start my-auto pb-1 right-[13%] w-[17%]">
                        <Text
                          className="capitalize sm:text-[17px] md:text-[19px] text-[21px] text-indigo-600"
                          size="txtPoppinsSemiBold21"
                        >
                  ...
                  <div className="flex flex-col items-end justify-start mb-[31px] ml-[-14px] mt-auto md:pl-10 sm:pl-5 pl-[108px] z-[1]">
                    <Text
                      className="capitalize sm:text-[17px] md:text-[19px] text-[21px] text-indigo-600"
                      size="txtPoppinsSemiBold21"
                    >
...
export default AdminReviewAccountModificationRequestsPage;
