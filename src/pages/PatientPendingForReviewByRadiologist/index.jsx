...
const PatientPendingForReviewByRadiologistPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-gray-900 font-outfit h-[859px] mx-auto p-[7px] relative w-full">
        <div className="md:h-[786px] h-[826px] sm:h-[835px] m-auto max-w-[1412px] md:px-5 w-full">
          ...
          <div className="absolute flex sm:flex-col flex-row font-poppins sm:gap-10 items-start justify-between left-[0] sm:pl-5 pl-[37px] py-[37px] top-[2%] w-[63%]">
            <Text
              className="capitalize sm:mt-0 mt-2 sm:text-4xl md:text-[38px] text-[40px] text-white-A700"
              size="txtPoppinsBold40"
            >
              Test Details
            </Text>
            <div className="md:h-[308px] h-[78px] sm:mt-0 mt-[230px] relative w-[4%] sm:w-full">
            ...
            <div className="h-[363px] sm:h-[543px] md:h-[631px] mb-[180px] sm:mt-0 mt-[88px] relative w-[39%] sm:w-full">
              <div className="bg-blue_gray-800 h-[363px] m-auto rounded-[10px] w-full"></div>
              <div className="absolute flex flex-col gap-7 inset-x-[0] items-center justify-start mx-auto top-[9%] w-[86%]">
                <Text
        ...
        <div className="absolute bg-gradient  bottom-[24%] md:h-[23px] h-[65px] inset-x-[0] mx-auto md:px-5 rounded-lg w-[361px]">
          <div className="flex flex-col h-full items-center justify-start m-auto">
            <Text
          ...
          <div className="absolute bg-gradient  flex flex-col md:h-auto h-full inset-[0] items-center justify-center m-auto rounded-lg w-[361px]">
...
export default PatientPendingForReviewByRadiologistPage;
