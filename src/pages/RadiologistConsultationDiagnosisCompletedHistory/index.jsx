...
const RadiologistConsultationDiagnosisCompletedHistoryPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-gray-900 font-outfit h-[859px] mx-auto p-[7px] relative w-full">
        <div className="absolute bg-blue_gray-900 flex flex-col h-max inset-[0] items-center justify-center m-auto max-w-[1411px] p-[21px] md:px-5 rounded-[10px] w-full">
          <div className="flex flex-col md:gap-10 gap-[371px] justify-start mt-[275px] w-[95%] md:w-full">
            <Button
              className="capitalize cursor-pointer font-semibold h-[65px] md:ml-[0] ml-[939px] rounded-lg text-center text-lg tracking-[0.36px] w-[361px]"
              shape="round"
              size="3xl"
...
export default RadiologistConsultationDiagnosisCompletedHistoryPage;
