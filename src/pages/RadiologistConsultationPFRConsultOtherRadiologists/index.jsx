...
const RadiologistConsultationPFRConsultOtherRadiologistsPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-gray-900 font-poppins h-[859px] mx-auto p-[7px] relative w-full">
        <div className="md:h-[795px] sm:h-[820px] h-[826px] m-auto max-w-[1420px] md:px-5 w-full">
          ...
          <div className="absolute flex flex-col items-start justify-start left-[0] p-[38px] sm:px-5 top-[4%] w-[63%]">
            ...
            <div className="flex sm:flex-col flex-row sm:gap-10 gap-[118px] items-start justify-start md:ml-[0] ml-[37px] mt-[350px] pt-2 px-2 w-[96%] md:w-full">
              <div className="flex flex-col items-center justify-start sm:mt-0 mt-2.5">
                <Text
              ...
              <Text
                className="capitalize sm:mt-0 mt-[9px] text-base text-gray-100"
                size="txtPoppinsMedium16"
              >
                Lab4
              </Text>
              <Text
                className="capitalize sm:mt-0 mt-2.5 text-base text-gray-100"
                size="txtPoppinsMedium16"
              >
                Request Declined by Radiologist
              </Text>
            </div>
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mb-[114px] md:ml-[0] ml-[35px] mt-5 p-1.5 w-[96%] md:w-full">
              <div className="flex flex-col items-center justify-start md:ml-[0] ml-[3px] md:mt-0 my-0.5">
                <Text
                  className="capitalize text-base text-gray-100"
                  size="txtPoppinsSemiBold16"
                >
              ...
              <Text
                className="capitalize mb-1 md:ml-[0] ml-[119px] text-base text-gray-100"
                size="txtPoppinsMedium16"
              >
                Lab5
              </Text>
              <Text
                className="capitalize md:ml-[0] ml-[118px] md:mt-0 my-0.5 text-base text-gray-100"
                size="txtPoppinsMedium16"
              >
        ...
        <div className="absolute bottom-[11%] flex flex-col md:gap-10 gap-[239px] justify-start left-[3%] md:px-5 w-[65%]">
              ...
              <div className="h-[206px] md:h-[258px] m-auto w-full">
                <div className="absolute flex flex-col h-full inset-[0] items-center justify-center m-auto pb-[67px] w-full">
                  <div className="flex flex-col items-start justify-start w-full">
                    <div className="flex flex-row sm:gap-10 gap-[252px] items-center justify-start md:ml-[0] ml-[53px] w-[81%] md:w-full">
                      <Text
          ...
          <Button
            ...
            onClick={() => navigate("/radiologistconsultationpendingforreview")}
            shape="round"
            size="sm"
            color="green_500_teal_400"
          >
...
export default RadiologistConsultationPFRConsultOtherRadiologistsPage;
