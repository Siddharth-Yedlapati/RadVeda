...
const RadiologistConsultationPendingForReviewPage = () => {
    ...
    <>
      <div className="bg-gray-900 font-outfit h-[859px] mx-auto p-[7px] relative w-full">
        <div className="absolute bg-blue_gray-900 flex flex-col h-max inset-[0] items-start justify-center m-auto max-w-[1411px] p-[21px] md:px-5 rounded-[10px] w-full">
          <div className="flex flex-col items-center justify-start md:ml-[0] ml-[17px] mt-[51px] w-[94%] md:w-full">
            <div className="flex flex-col justify-start w-full">
              <div className="bg-gradient  flex flex-col h-[42px] md:h-auto items-center justify-center md:ml-[0] ml-[930px] rounded-lg w-[279px]">
              ...
              <div className="flex flex-row font-poppins items-center justify-end md:ml-[0] ml-[901px] mt-[11px] w-[28%] md:w-full">
              ...
              <div className="flex flex-col font-outfit gap-[23px] items-center justify-start md:ml-[0] ml-[913px] mt-[31px] w-[29%] md:w-full">
                <Button
              ...
              <div className="flex md:flex-col flex-row font-outfit md:gap-5 items-end justify-start mt-[18px] w-full">
                <Button
            ...
            <div className="flex flex-col font-outfit gap-[21px] items-center justify-start ml-3 md:ml-[0] mt-[27px] w-[99%] md:w-full">
              <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                ...
                <Button
                  className="common-pointer capitalize cursor-pointer font-semibold h-[65px] rounded-lg text-center text-lg tracking-[0.36px] w-[361px]"
                  onClick={() =>
                    navigate("/radiologistconsultationpfrimageannotater")
                  }
                  shape="round"
                  size="3xl"
                  color="green_500_teal_400"
...
export default RadiologistConsultationPendingForReviewPage;
