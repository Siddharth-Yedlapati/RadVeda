package RadVeda.Radiologist.transitEncryption;
...
public class EncryptionService {
    ...
    public void generateKeyPair() {
        ...
        try {
            ...
            radiologist = gen.generateKeyPair();

            byte[] keyBytes = radiologist.getPublic().getEncoded();
...
//            String base64encodedKey = Base64.
            ...
            ResponseEntity<String> res  = restTemplate.exchange("http://localhost:9191/encryptor/sendPublicKey/radiologist",
    ...
    public String storeSharedKey(String service, byte[] keyBytes) {
        try {
            String sharedKey = decrypt(keyBytes, radiologist.getPrivate());
