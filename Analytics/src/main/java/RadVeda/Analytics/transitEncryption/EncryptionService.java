package RadVeda.Analytics.transitEncryption;
...
public class EncryptionService {
    ...
    public void generateKeyPair() {
        ...
        try {
            ...
            analytics = gen.generateKeyPair();

            byte[] keyBytes = analytics.getPublic().getEncoded();
...
//            String base64encodedKey = Base64.
            ...
            ResponseEntity<String> res  = restTemplate.exchange("http://localhost:9191/encryptor/sendPublicKey/analytics",
    ...
    public String storeSharedKey(String service, byte[] keyBytes) {
        try {
            String sharedKey = decrypt(keyBytes, analytics.getPrivate());
