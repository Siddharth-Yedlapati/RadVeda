...
public class EncryptionService {
    ...
    public void generateKeyPair() {
        ...
        try {
            ...
            labStaff = gen.generateKeyPair();

            byte[] keyBytes = labStaff.getPublic().getEncoded();
...
//            String base64encodedKey = Base64.
            ...
            ResponseEntity<String> res  = restTemplate.exchange("http://localhost:9191/encryptor/sendPublicKey/labStaff",
    ...
    public String storeSharedKey(String service, byte[] keyBytes) {
        try {
            String sharedKey = decrypt(keyBytes, labStaff.getPrivate());
