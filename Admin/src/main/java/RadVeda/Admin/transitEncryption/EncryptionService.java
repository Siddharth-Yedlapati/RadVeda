...
public class EncryptionService {
    ...
    public void generateKeyPair() {
        ...
        try {
            ...
            admin = gen.generateKeyPair();

            byte[] keyBytes = admin.getPublic().getEncoded();
...
//            String base64encodedKey = Base64.
            ...
            ResponseEntity<String> res  = restTemplate.exchange("http://localhost:9191/encryptor/sendPublicKey/admin",
    ...
    public String storeSharedKey(String service, byte[] keyBytes) {
        try {
            String sharedKey = decrypt(keyBytes, admin.getPrivate());
