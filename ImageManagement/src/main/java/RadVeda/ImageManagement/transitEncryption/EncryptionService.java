...
public class EncryptionService {
    ...
    public void generateKeyPair() {
        ...
        try {
            ...
            IMS = gen.generateKeyPair();

            byte[] keyBytes = IMS.getPublic().getEncoded();
...
//            String base64encodedKey = Base64.
            ...
            ResponseEntity<String> res  = restTemplate.exchange("http://localhost:9191/encryptor/sendPublicKey/IMS",
    ...
    public String storeSharedKey(String service, byte[] keyBytes) {
        try {
            String sharedKey = decrypt(keyBytes, IMS.getPrivate());
