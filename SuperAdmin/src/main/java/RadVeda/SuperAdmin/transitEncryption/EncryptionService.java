package RadVeda.SuperAdmin.transitEncryption;
...
public class EncryptionService {
    ...
    public void generateKeyPair() {
        ...
        try {
            ...
            superAdmin = gen.generateKeyPair();

            byte[] keyBytes = superAdmin.getPublic().getEncoded();
...
//            String base64encodedKey = Base64.
            ...
            ResponseEntity<String> res  = restTemplate.exchange("http://localhost:9191/encryptor/sendPublicKey/superAdmin",
    ...
    public String storeSharedKey(String service, byte[] keyBytes) {
        try {
            String sharedKey = decrypt(keyBytes, superAdmin.getPrivate());
