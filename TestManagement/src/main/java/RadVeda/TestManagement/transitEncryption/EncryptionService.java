...
public class EncryptionService {
    ...
    public void generateKeyPair() {
        ...
        try {
            ...
            TMS = gen.generateKeyPair();

            byte[] keyBytes = TMS.getPublic().getEncoded();
...
//            String base64encodedKey = Base64.
            ...
            ResponseEntity<String> res  = restTemplate.exchange("http://localhost:9191/encryptor/sendPublicKey/TMS",
    ...
    public String storeSharedKey(String service, byte[] keyBytes) {
        try {
            String sharedKey = decrypt(keyBytes, TMS.getPrivate());
